...
export const PersonIcon: React.FC<IconProps> = ({ className = '', size = 24 }) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="currentColor">
...
export const AppsGridIcon: React.FC<IconProps> = ({ className = '', size = 24 }) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="currentColor">
    <path d="M4 8h4V4H4v4zm6 12h4v-4h-4v4zm-6 0h4v-4H4v4zm0-6h4v-4H4v4zm6 0h4v-4h-4v4zm6-10v4h4V4h-4zm-6 4h4V4h-4v4zm6 6h4v-4h-4v4zm0 6h4v-4h-4v4z" />
  </svg>
);
...
export const ReportingIcon: React.FC<IconProps> = ({ className = '', size = 24 }) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="currentColor">
...
export const RulesIcon: React.FC<IconProps> = ({ className = '', size = 24 }) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="currentColor">
...
export const UpgradeIcon: React.FC<IconProps> = ({ className = '', size = 24 }) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="currentColor">
...
export const MoreVertIcon: React.FC<IconProps> = ({ className = '', size = 24 }) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="currentColor">
...
export const GridViewIcon: React.FC<IconProps> = ({ className = '', size = 24 }) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="currentColor">
    <path d="M4 8h4V4H4v4zm6 12h4v-4h-4v4zm-6 0h4v-4H4v4zm0-6h4v-4H4v4zm6 0h4v-4h-4v4zm6-10v4h4V4h-4zm-6 4h4V4h-4v4zm6 6h4v-4h-4v4zm0 6h4v-4h-4v4z" />
  </svg>
);

// Google Workspace Logo (colorful G)
export const GoogleWorkspaceIcon: React.FC<IconProps> = ({ className = '', size = 40 }) => (
...
// Google Admin Logo (Blue Hexagon with hexagonal hole)
export const GoogleAdminLogo: React.FC<{ className?: string; size?: number }> = ({ className = '', size = 40 }) => (
  <svg className={className} width={size} height={size} viewBox="0 0 48 48">
    {/* Outer hexagon */}
    <path
...
// Error/Warning icons for alerts
...
export const VisaLogo: React.FC<{ className?: string }> = ({ className = '' }) => (
  <svg className={className} width="50" height="16" viewBox="0 0 50 16" fill="none">
...
export const MastercardLogo: React.FC<{ className?: string }> = ({ className = '' }) => (
  <svg className={className} width="32" height="20" viewBox="0 0 32 20" fill="none">
    ...
    <path fillRule="evenodd" clipRule="evenodd" d="M16 16.5C18.3 14.8 19.8 12.1 19.8 9C19.8 6.4 18.7 4.1 16.9 2.5C15.1 4.1 14 6.4 14 9C14 12.1 15.5 14.8 17.8 16.5C17.2 16.8 16.6 17 16 17.1C15.4 17 14.8 16.8 14.2 16.5C11.9 14.8 10.4 12.1 10.4 9C10.4 6.4 11.5 4.1 13.3 2.5C11.5 0.9 9.3 0 7 0C3.1 0 0 3.6 0 8C0 12.4 3.1 16 7 16C9.3 16 11.5 15.1 13.3 13.5C11.5 15.1 9.3 16 7 16C10.9 16 14 12.4 14 8C14 3.6 10.9 0 7 0" fill="#FF5F00"/>
  </svg>
);

// Google logo for auth pages
export const GoogleLogo: React.FC<{ className?: string; size?: number }> = ({ className = '', size = 48 }) => (
  <svg className={className} width={size} height={size} viewBox="0 0 48 48">
    <path fill="#FFC107" d="M43.611,20.083H42V20H24v8h11.303c-1.649,4.657-6.08,8-11.303,8c-6.627,0-12-5.373-12-12c0-6.627,5.373-12,12-12c3.059,0,5.842,1.154,7.961,3.039l5.657-5.657C34.046,6.053,29.268,4,24,4C12.955,4,4,12.955,4,24c0,11.045,8.955,20,20,20c11.045,0,20-8.955,20-20C44,22.659,43.862,21.35,43.611,20.083z"/>
    <path fill="#FF3D00" d="M6.306,14.691l6.571,4.819C14.655,15.108,18.961,12,24,12c3.059,0,5.842,1.154,7.961,3.039l5.657-5.657C34.046,6.053,29.268,4,24,4C16.318,4,9.656,8.337,6.306,14.691z"/>
    <path fill="#4CAF50" d="M24,44c5.166,0,9.86-1.977,13.409-5.192l-6.19-5.238C29.211,35.091,26.715,36,24,36c-5.202,0-9.619-3.317-11.283-7.946l-6.522,5.025C9.505,39.556,16.227,44,24,44z"/>
